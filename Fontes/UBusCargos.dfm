inherited Frm_BusCargos: TFrm_BusCargos
  Top = 179
  ...
  object SQLBusCargos: TSQLDataSet
    CommandText = 
    ...
    Left = 24
    Top = 8
    object SQLBusCargosIDCAR: TIntegerField
      FieldName = 'IDCAR'
      Required = True
    end
    object SQLBusCargosDESC_CAR: TStringField
      FieldName = 'DESC_CAR'
      Required = True
      Size = 30
    end
    object SQLBusCargosSTATUS_CAR: TStringField
      FieldName = 'STATUS_CAR'
      Required = True
      Size = 1
    end
  ...
  object ProviderBus: TDataSetProvider
    DataSet = SQLBusCargos
    Left = 64
    Top = 8
  end
  object CDSBusCargos: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'ProviderBus'
    Left = 104
    Top = 8
    object CDSBusCargosIDCAR: TIntegerField
      FieldName = 'IDCAR'
      Required = True
    end
    object CDSBusCargosDESC_CAR: TStringField
      FieldName = 'DESC_CAR'
      Required = True
      Size = 30
    end
    object CDSBusCargosSTATUS_CAR: TStringField
      FieldName = 'STATUS_CAR'
      Required = True
      Size = 1
    end
  end
  object DSBusCargos: TDataSource
    DataSet = CDSBusCargos
    Left = 144
    Top = 8
  end
