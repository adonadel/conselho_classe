inherited FrmBuscaCep: TFrmBuscaCep
  ...
  object SqlCep: TSQLDataSet
    CommandText = 
      ...
      'TER JOIN TIPOLOGRA ON (TIPOLOGRA.IDTIPOLOG = CEPS.IDTIPOLOG)'#13#10
    MaxBlobSize = -1
    Params = <>
