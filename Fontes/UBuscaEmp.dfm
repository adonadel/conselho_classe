inherited FrmBuscaEmp: TFrmBuscaEmp
  Left = 283
  Top = 129
  Caption = 'Busca de Empresa'
  ClientHeight = 540
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object SqlEmpresaBusca: TSQLDataSet
    CommandText = 'SELECT '#13#10#13#10'*'#13#10#13#10'FROM EMPRESA'
    MaxBlobSize = -1
    Params = <>
  ...
  object PROVIDER: TDataSetProvider
    DataSet = SqlEmpresaBusca
    Left = 48
    Top = 16
  end
  object DSempresa: TDataSource
    DataSet = CdsEmpresaBusca
    Left = 112
    Top = 16
  end
  object CdsEmpresaBusca: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'PROVIDER'
    Left = 80
    Top = 16
    object CdsEmpresaBuscaIDEMP: TIntegerField
      FieldName = 'IDEMP'
      Required = True
    end
    object CdsEmpresaBuscaCOMPEND_EMP: TStringField
      FieldName = 'COMPEND_EMP'
      Size = 100
    end
    object CdsEmpresaBuscaNOMEFAN_EMP: TStringField
      FieldName = 'NOMEFAN_EMP'
      Required = True
      Size = 50
    end
    object CdsEmpresaBuscaRAZAOSOC_EMP: TStringField
      FieldName = 'RAZAOSOC_EMP'
      Required = True
      Size = 50
    end
    object CdsEmpresaBuscaCNPJ_EMP: TStringField
      FieldName = 'CNPJ_EMP'
      Required = True
      Size = 14
    end
    object CdsEmpresaBuscaINSCEST_EMP: TStringField
      FieldName = 'INSCEST_EMP'
      Required = True
      Size = 14
    end
    object CdsEmpresaBuscaFONE_EMP: TStringField
      FieldName = 'FONE_EMP'
      Size = 11
    end
    object CdsEmpresaBuscaSITE_EMP: TStringField
      FieldName = 'SITE_EMP'
      Size = 30
    end
    object CdsEmpresaBuscaFAX_EMP: TStringField
      FieldName = 'FAX_EMP'
      Size = 11
    end
    object CdsEmpresaBuscaEMAIL_EMP: TStringField
      FieldName = 'EMAIL_EMP'
      Size = 100
    end
    object CdsEmpresaBuscaSTATUS_EMP: TStringField
      FieldName = 'STATUS_EMP'
      Required = True
      Size = 1
    end
  end
  object RaveProjeto: TRvProject
    Engine = RvSystem1
    Left = 32
    Top = 329
  end
  object RaveConexao: TRvDataSetConnection
