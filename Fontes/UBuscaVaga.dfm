inherited FrmBuscaVaga: TFrmBuscaVaga
  Left = 292
  Top = 153
  Caption = 'Busca de Vagas'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited GridDados: TRzDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = 'Bolsa Aux'#237'lio'
          Title.Font.Charset = ANSI_CHARSET
          Title.Font.Color = clWindowText
          Title.Font.Height = -13
          Title.Font.Name = 'Times New Roman'
  ...
  inherited PNLFILTRO: TRzPanel
    ...
    object CodIni: TLabeledEdit
      ...
      EditLabel.Width = 39
      EditLabel.Height = 13
      EditLabel.Caption = 'C'#243'd. Ini:'
      Enabled = False
      LabelPosition = lpLeft
      TabOrder = 5
    end
    object CodFin: TLabeledEdit
      Left = 152
      Top = 128
      Width = 33
      Height = 21
  ...
  object SqlVaga: TSQLDataSet
    CommandText = 
      ...
      ' ON (TURMAS.IDTUR = RELTURALU.IDTUR)'#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object RaveConectar: TRvDataSetConnection
