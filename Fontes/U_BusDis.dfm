inherited FRM_BUSDIS: TFRM_BUSDIS
  Left = 362
  Top = 162
  Caption = 'FRM_BUSDIS'
  OldCreateOrder = True
  ...
  object SQLdisBus: TSQLDataSet
    CommandText = 
      'SELECT'#13#10#13#10' DISCIPLINAS.IDDISC,'#13#10' DISCIPLINAS.DESCR_DISC,'#13#10' DISCI' +
      'PLINAS.STATUS_DISC'#13#10#13#10'FROM DISCIPLINAS'#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.Conexao
    Left = 16
    Top = 8
    object SQLdisBusIDDISC: TIntegerField
      FieldName = 'IDDISC'
      Required = True
    end
    object SQLdisBusDESCR_DISC: TStringField
      FieldName = 'DESCR_DISC'
      Size = 50
    end
    object SQLdisBusSTATUS_DISC: TStringField
      FieldName = 'STATUS_DISC'
      Required = True
      Size = 1
    end
  ...
  object CDSdisBus: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'PROVIDER'
    Left = 144
    Top = 8
    object CDSdisBusIDDISC: TIntegerField
      FieldName = 'IDDISC'
      Required = True
    end
    object CDSdisBusDESCR_DISC: TStringField
      FieldName = 'DESCR_DISC'
      Size = 50
    end
    object CDSdisBusSTATUS_DISC: TStringField
      FieldName = 'STATUS_DISC'
      Required = True
      Size = 1
    end
  end
  object DSdisBus: TDataSource
    DataSet = CDSdisBus
    Left = 216
    Top = 8
  end
  ...
  object RaveConection2: TRvDataSetConnection
