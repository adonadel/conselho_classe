inherited FRM_BUSTUR: TFRM_BUSTUR
  Left = 266
  Top = 131
  Caption = 'FRM_BUSTUR'
  OldCreateOrder = True
  ...
  object SQLbustur: TSQLDataSet
    CommandText = 
      ...
      'URSOS.IDCURSO=TURMAS.IDCURSO)'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.Conexao
    Left = 32
    Top = 8
    object SQLbusturIDTUR: TIntegerField
      FieldName = 'IDTUR'
      Required = True
    end
    object SQLbusturIDCURSO: TIntegerField
      FieldName = 'IDCURSO'
      Required = True
    end
    object SQLbusturNUM_TUR: TStringField
      FieldName = 'NUM_TUR'
      Required = True
      Size = 10
    end
    object SQLbusturTURNO_TUR: TStringField
      FieldName = 'TURNO_TUR'
      Size = 1
    end
    object SQLbusturANO_TUR: TIntegerField
      FieldName = 'ANO_TUR'
      Required = True
    end
    object SQLbusturSTATUS_TUR: TStringField
      FieldName = 'STATUS_TUR'
      Required = True
      Size = 1
    end
    object SQLbusturDESCRICAO_CUR: TStringField
      FieldName = 'DESCRICAO_CUR'
      ProviderFlags = []
    end
  end
  ...
  object CDSbustur: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'PROVIDERBUS'
    Left = 176
    Top = 8
    object CDSbusturIDTUR: TIntegerField
      FieldName = 'IDTUR'
      Required = True
    end
    object CDSbusturIDCURSO: TIntegerField
      FieldName = 'IDCURSO'
      Required = True
    end
    object CDSbusturNUM_TUR: TStringField
      FieldName = 'NUM_TUR'
      Required = True
      Size = 10
    end
    object CDSbusturTURNO_TUR: TStringField
      FieldName = 'TURNO_TUR'
      Size = 1
    end
    object CDSbusturANO_TUR: TIntegerField
      FieldName = 'ANO_TUR'
      Required = True
    end
    object CDSbusturSTATUS_TUR: TStringField
      FieldName = 'STATUS_TUR'
      Required = True
      Size = 1
    end
    object CDSbusturDESCRICAO_CUR: TStringField
      FieldName = 'DESCRICAO_CUR'
      ProviderFlags = []
    end
  end
  object DSbustur: TDataSource
    DataSet = CDSbustur
    Left = 248
    Top = 8
  end
