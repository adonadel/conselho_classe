...
begin
  try
    ...
    RzStatusPane1.Caption   := ' Versão: ' + IntToStr(versao);
    ...
    EXCEPT
      ...
      '  Possíveis Causas:'+#10+#13+'    '+#26+'Algum parâmetro, como fonte ou cor dos painéis;'+#10+#13+
      '    '+#26+'A fonte do título pode estar errado.'+#10+#13+'  Definidos parâmetros padrão para o Sistema!'+#10+#13+
      '    '+#26+'Vá em Configurações e defina os seus Parâmetros para os Cadastros.');
